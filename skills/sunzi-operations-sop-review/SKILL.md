...
7. Select 1 to 3 canonical Thirty-Six Stratagems lenses only if they clarify bottleneck removal, prepared capacity, sequencing, or retreat.
8. Run `strategy-analyst-review` before approving the SOP: second-order effects, frontline burden, customer trust, compliance, metrics, and kill criterion.
9. Output a revised SOP review with required changes, acceptance criteria, and monitoring plan.
